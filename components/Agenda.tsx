                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex justify-between items-center flex-wrap gap-x-2">
                            <p className="text-md font-semibold text-gray-900 dark:text-white flex-1">{event.title}</p>
                             {event.isAllDay ? (
                              <span className="text-xs font-medium text-gray-600 dark:text-gray-300 whitespace-nowrap bg-gray-100 dark:bg-gray-700 px-2 py-2.5 rounded-full">Todo el día</span>
                            ) : (
