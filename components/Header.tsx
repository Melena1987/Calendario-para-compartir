    ...
    return (
      <header className="flex flex-col sm:flex-row items-center justify-between mb-6 gap-4">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 mt-4 sm:mt-0">
          ...
          <button
            onClick={onDownload}
            className="w-full sm:w-auto flex items-center justify-center space-x-2 bg-blue-600 text-white font-semibold px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200 shadow-md"
          >
